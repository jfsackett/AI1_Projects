...
/** Solves puzzle by using heuristic which minimizes # moves to state + tiles out of place. */
public class AstarMinTilesWrongSearchStrategy implements SearchStrategy {
	
	/** Perform A* search by minimizing # moves to state + # tiles out of place and return results info. */
	...
	private static void insertIntoHeuristicSortedLoc(PuzzleMove newPuzzleMove, PuzzleState goalPuzzleState, LinkedList<PuzzleMove> frontierPuzzleMoves) {
		...
		AstarMinTilesWrongVisitor visitor = new AstarMinTilesWrongVisitor(newPuzzleMove, goalPuzzleState, frontierPuzzleMoves.size());
